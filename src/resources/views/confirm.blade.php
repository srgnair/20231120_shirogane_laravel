...
<div class="confirm__content">
    ...
    <form class="form" action="/contacts" method="post">
            ...
            <table class="confirm-table__inner">
                <tr class="confirm-table__row">
                    ...
                    <td class="confirm-table__text">
                        <input class="input__last-name" type="text" name="last_name" value="{{ $contact['last_name'] }}" readonly />
                        <input class="input__first-name" type="text" name="first_name" value="{{ $contact['first_name'] }}" readonly />
                    </td>
                </tr>
                <tr class="confirm-table__row">
        ...
        <div class="correct__button">
            <a class="correct__button--text" onClick="history.back()">修正する</a>
        </div>
